...
void Scene_Stage_01::Enter()
{
 ...
 //오브젝트 추가
	...
	CCollisionMgr::GetInst()->CheckGroup(GROUP_TYPE::PLAYER, GROUP_TYPE::TRIGGER); // 플레이어와 트리거 충돌 체크
	...
	CCollisionMgr::GetInst()->CheckGroup(GROUP_TYPE::HOOK, GROUP_TYPE::GROUND);
